...
Packer.toBuffer(doc).then(b => { fs.writeFileSync('/Users/nito/Code/_word-check3.docx', b); console.log('生成: _word-check3.docx', b.length, 'bytes'); });
